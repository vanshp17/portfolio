...
// import salesImg from '../assets/images/sales2.png';
  ...
  dataAnalyst: [
    {
      ...
      problem: 'The project involves analyzing road accident data to identify key patterns and factors contributing to accidents. The objective is to develop a dashboard that provides actionable insights for policymakers, traffic authorities, and the general public to enhance road safety measures.',
      solution: 'To analyze road accident data, identify trends, and provide insights through visualizations. The project involves analyzing data, identifying key indicators, and creating an actionable tool that helps stakeholders make informed decisions.',
      dataCollection: [
  ...
  },
    {
      ...
      problem: 'Analyze customer behavior and transaction history to identify key factors influencing customer churn in an e-commerce platform. The goal is to provide data-driven insights to help businesses retain customers.',
      solution: 'Understand patterns and trends in customer churn. Identify critical factors that contribute to customer retention and churn. Provide actionable recommendations for improving customer engagement and satisfaction.',
      dataCollection: [
  ...
  },
    {
      ...
      githubLink: 'https://github.com/vanshp17/GooglePlayStoreAnalysis',
      problem: 'The Google Play Store hosts thousands of apps, making it essential for developers and investors to analyze trends and make data-driven decisions. This project focuses on visualizing key insights from the Play Store dataset using Power BI.',
      solution: 'Develop an interactive Power BI dashboard to provide insights into app performance, installs, revenue trends, and user behavior on the Google Play Store.',
  ...
  dataScientist: [
    ...
    // Add more data scientist projects here
        ...
        },
        {
          ...
          problem:'Predicting laptop prices based on specifications using a machine learning model and deploying it as a Streamlit web application.',
          solution: 'To develop an interactive web application that allows users to input laptop specifications and receive an estimated price prediction using a trained machine learning model.',
          dataCollection: [
        ...
        },
        {
          ...
          problem:'Predict the price of a used car based on various features such as brand, model, year of purchase, fuel type, and kilometers driven. The goal is to assist buyers and sellers in estimating fair market value.',
          solution:['Build a machine learning model to predict car prices accurately.',
        ...
        <div className="project-info">
          ...
          <p className="project-description">
            {Array.isArray(project.insights) 
              ? project.insights[0] // Display the first insight as a preview
              : project.insights.substring(0, 100)}...
          </p>
